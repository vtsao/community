...
This app was forked from [flightsnearby](https://github.com/tidbyt/community/tree/main/apps/flightsnearby) and uses [adsb.lol](https://adsb.lol) for flight data instead of Flight Radar, since adsb.lol is free.
